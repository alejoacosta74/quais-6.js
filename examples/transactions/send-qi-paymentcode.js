...
async function main() {
	...
	console.log("Alice sent transaction: ", tx);

	// Wait for tx to be mined
	const txReceipt = await tx.wait();
	console.log("Alice sent transaction receipt: ", txReceipt);
	...
	console.log("Bob sent transaction: ", tx2);

	// Wait for tx2 to be mined
	const tx2Receipt = await tx2.wait();
	console.log("Bob sent transaction receipt: ", tx2Receipt);
